...
#define URL_FETCH_WECHAT_TOKEN @"https://api.weixin.qq.com/sns/oauth2/access_token"

@interface FetchWechatTokenApi() <ResponseDelegate, Api>
@property(nonatomic, weak) id <ResponseDelegate> delegate; /**< 回调的代理 */
@property(nonatomic, strong) NSDictionary *params; /**< 外部传入的请求参数 */
@end

@implementation FetchWechatTokenApi 
