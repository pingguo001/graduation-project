...
- (void)fileJudge{
    ...
    NSString *videoName = [[NSString MD5Of32BitLowerString:self.videoUrl] stringByAppendingString:[NSString stringWithFormat:@".%@", [[self.videoUrl componentsSeparatedByString:@"."] lastObject]]];
    //定义文件的临时下载路径
