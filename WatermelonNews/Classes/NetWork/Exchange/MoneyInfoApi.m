...
@interface MoneyInfoApi() <ResponseDelegate, Api>

@end

@implementation MoneyInfoApi
...
- (NSString *_Nonnull)url {
    return [URL_BASE_NEWS stringByAppendingString:getMoneyInfoUrl];
}
 ...
 */
- (void)call {
    [self sendWithType:GET priority:PRIORITY_MIDDLE];
}
