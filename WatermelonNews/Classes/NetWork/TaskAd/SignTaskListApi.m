...
@interface SignTaskListApi() <ResponseDelegate, Api>

@end

@implementation SignTaskListApi
...
- (NSString *_Nonnull)url {
    return [URL_BASE_ICC stringByAppendingString:SignTasksUrl];
}
 ...
 */
- (void)call {
    [self sendWithType:POST priority:PRIORITY_HIGHER];
}
